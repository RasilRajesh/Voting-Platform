...
INSTALLED_APPS = [
    ...
    'social_django',
    'corsheaders',
    # 'drf_yasg',  # API documentation (optional - install with: pip install drf-yasg)
    # 'django_filters',  # Filtering (optional - install with: pip install django-filter)
    'users',
    'candidates',
    'votes',
]
...
#         'NAME': config('DB_NAME', default='voting_platform'),
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@votingplatform.com')
